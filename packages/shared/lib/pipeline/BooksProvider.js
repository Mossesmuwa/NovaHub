// packages/shared/lib/pipeline/BooksProvider.js
...
/**
 * BooksProvider â€” pulls notable books from Google Books API.
 *
 * Environment:
 *   GOOGLE_BOOKS_API_KEY  (optional â€” works without key but rate limited)
 *
 * Produces items with:
...
export class BooksProvider extends BaseProvider {
   ...
   * @param {number} [options.limitPerQuery=5] â€” books per search query
   */
  constructor(options = {}) {
    super("Books");
