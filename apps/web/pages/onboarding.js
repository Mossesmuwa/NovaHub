...
export default function OnboardingPage() {
  ...
  function finish() {
    try {
      localStorage.setItem(
        "nova_taste",
        JSON.stringify({ cats, loved, mood, ts: Date.now() }),
      );
  ...
  if (step === 3) finish();
  const tags = [...cats, ...loved];
  if (mood) tags.unshift(mood);
        ...
        <div className="onboard-card">
          ...
          {step === 0 && (
            <div className="onboard-step active">
              <div className="onboard-step-title">
                What worlds do you explore?
              </div>
              <div className="onboard-step-sub">
                Pick everything that interests you. NovaHub fills your feed from
                these areas.
              </div>
              ...
              <div className="onboard-footer">
                <span className="onboard-skip" onClick={skip}>
                  Skip for now
                </span>
          ...
          {step === 1 && (
            <div className="onboard-step active">
              ...
              <div className="swipe-progress">
                Item {Math.min(swipeIdx + 1, items.length)} of {items.length}
              </div>
              ...
              <div className="onboard-footer">
                <span className="onboard-skip" onClick={() => next(1)}>
                  Skip this step
                </span>
              </div>
            </div>
          ...
          {step === 2 && (
            <div className="onboard-step active">
              ...
              <div className="onboard-step-sub">
                Shapes what shows first on your homepage. Change anytime.
              </div>
              <div className="mood-grid">
                {[
                  ...
                  >
                    <span className="mood-em">{m.em}</span>
              ...
              <div className="onboard-footer">
                <span className="onboard-skip" onClick={() => next(2)}>
                  Skip
                </span>
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="onboard-step-sub" style={{ textAlign: "center" }}>
                NovaHub now knows your taste. Recommendations are personalised.
              </div>
              <div
                style={{
                  background: "var(--bg3)",
