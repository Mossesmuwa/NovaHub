...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        setTaste(JSON.parse(localStorage.getItem("nova_taste") || "null"));
      } catch {}
      setLoading(false);
    };
    loadData();
  ...
  return (
    <Layout>
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg, var(--bg2) 0%, var(--bg3) 50%, var(--bg2) 100%)",
      ...
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div
            ref={tabsRef}
            style={{ display: "flex", position: "relative", marginTop: 8 }}
          >
            <div
              style={{
                position: "absolute",
                ...
                transition:
                  "left .25s cubic-bezier(.22,1,.36,1), width .25s cubic-bezier(.22,1,.36,1)",
              }}
            />
            {TABS.map((t) => (
              <button
            ...
            <div>
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: 13, color: "var(--t3)" }}>
                    Curate and share your discoveries
                  </p>
                </div>
                <button
            ...
            <div style={{ maxWidth: 640 }}>
              <div style={{ marginBottom: 32 }}>
                ...
                <p style={{ fontSize: 14, color: "var(--t3)" }}>
                  Built from your onboarding quiz and saves.
                </p>
              </div>
                  ...
                  {taste.mood && (
                    ...
                    >
                      ...
                      >
                        ...
                        {!["learn", "entertain", "tools", "explore"].includes(
                          taste.mood,
                        ) && taste.mood}
                      </div>
                    </div>
          ...
          {tab === "settings" && (
            <div style={{ maxWidth: 560 }}>
                ...
                {pMsg && (
                  <div
                    style={{
                      marginTop: 10,
                      fontSize: 13,
                      color: pMsg.includes("Error") ? "#FF453A" : "#30D158",
                    }}
                  >
                    {pMsg}
                  </div>
              ...
              >
                ...
                <p
                  style={{ fontSize: 13, color: "var(--t3)", marginBottom: 16 }}
                >
