  ...
  return (
    <>
      ...
      <div className="top-bar">
        ...
        <button className="icon-btn" id="theme-btn">
        ...
        <div className="auth-card">
          ...
          <div className="perks">
            <div className="perk">
              ...
              <strong>Unlimited Saves</strong>Save as many items as you want
            </div>
            <div className="perk">
              <span className="perk-icon">
              ...
              <strong>AI Recs</strong>Personalised to your taste
            </div>
            <div className="perk">
              <span className="perk-icon">
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M9 3H5a2 2 0 0 0-2 2v4m0 0H3m16 0h2a2 2 0 0 1 2 2v4m0 0v6a2 2 0 0 1-2 2h-4m-6 0H5a2 2 0 0 1-2-2v-6m0 0H3m14 0h2" />
                </svg>
              </span>
              <strong>Lists</strong>Create and share lists
            </div>
            <div className="perk">
              <span className="perk-icon">
                <svg
              ...
              <strong>Sync</strong>Any device, anytime
            </div>
          </div>
          <button className="btn-oauth" onClick={() => Auth.loginWithGoogle()}>
          ...
          <button className="btn-oauth" onClick={() => Auth.loginWithGithub()}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className="btn-oauth" onClick={() => Auth.loginWithApple()}>
            <svg viewBox="0 0 24 24" fill="currentColor">
