...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (!u) {
        router.replace("/account/login?return=/account/favorites");
        return;
      }
  ...
  return (
    <Layout>
      ...
      <div className="fav-hero">
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontSize: "15px", color: "var(--t2)" }}>
            Everything you&apos;ve saved across all categories.
          </p>
        </div>
      </div>
      <div className="container" style={{ paddingBottom: "80px" }}>
        ...
        >
          <button
            className={`sort-pill${typeFilter === "all" ? " active" : ""}`}
          ...
          {Object.keys(types).map((t) => (
            <button
              key={t}
              className={`sort-pill${typeFilter === t ? " active" : ""}`}
        ...
        {sorted.length === 0 ? (
          <div className="empty-state">
            ...
            <p>
              {search.trim() || typeFilter !== "all"
                ...
                : "Browse NovaHub and save things you love."}
            </p>
            {!(search.trim() || typeFilter !== "all") && (
              <Link
                href="/"
          ...
          <div
            className={
              sorted.some((i) => ["movie", "book", "game"].includes(i.type))
                ? "grid-4"
                : "grid-3"
            }
          >
