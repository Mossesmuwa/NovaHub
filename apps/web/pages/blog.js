...
const POSTS = [
  { id:'1', slug:'best-ai-tools-2026', title:'The 10 Best AI Tools You Actually Need in 2026', category:'AI', author:'NovaHub', date:'Apr 14, 2026', readTime:6, excerpt:'AI is moving faster than ever. A no-fluff breakdown of the tools genuinely worth your time this year â€” from writing to coding to image generation.', image:'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=480&fit=crop&q=80', featured:true },
  { id:'2', slug:'getting-started-cybersecurity-2026', title:'Getting Started in Cyber Security: A 2026 Roadmap', category:'Security', author:'NovaHub', date:'Apr 7, 2026', readTime:9, excerpt:'The honest, no-hype roadmap from beginner to first job â€” including every free resource you need to get there.', image:'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&h=480&fit=crop&q=80' },
  ...
  { id:'5', slug:'books-every-developer-should-read', title:'7 Books Every Developer Should Read Before 2027', category:'Books', author:'NovaHub', date:'Mar 14, 2026', readTime:4, excerpt:'Beyond the technical manuals â€” these seven books will change how you think about software, teams, and your career.', image:'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=800&h=480&fit=crop&q=80' },
...
export default function BlogPage() {
  ...
  return (
    <Layout activePage="blog">
      <SEO title="Blog â€” NovaHub" description="Insights on AI, cyber security, movies, games, and the best of the internet." />
      ...
      <div className="blog-hero">
        ...
        <div className="container blog-hero-inner">
          <div className="blog-label">Editorial Â· {POSTS.length} posts</div>
          <h1 className="blog-title">NovaHub Blog</h1>
          <p className="blog-sub">Insights on AI, cyber security, movies, games, and the best of the internet â€” curated by our team.</p>
        </div>
      </div>
      ...
      <div className="container" style={{ paddingBottom: 80 }}>
            ...
            <Link href={`/blog/${featured.slug}`} className="blog-featured">
              ...
              <div className="blog-featured-body">
                ...
                <div className="blog-featured-meta">
                  {featured.date} Â· {featured.readTime} min read
                </div>
                <span className="btn-ghost" style={{ alignSelf: 'flex-start', marginTop: 4 }}>Read Article â†’</span>
              </div>
            </Link>
          </div>
        )}
              ...
              <Link href={`/blog/${p.slug}`} className="blog-card reveal-scale" key={p.id}>
                ...
                <div className="blog-card-body">
                  ...
                  <div className="blog-card-foot">
                    ...
                    <span>{p.date} Â· {p.readTime}m</span>
                  </div>
                </div>
              </Link>
            );
        ...
        <div className="nl-section reveal" style={{ marginTop: 48 }}>
          ...
          <h2 className="nl-title" style={{ position: 'relative' }}>ðŸ“¬ Stay in the Loop</h2>
          <p className="nl-sub" style={{ position: 'relative' }}>Get the best of NovaHub delivered weekly â€” free, no spam.</p>
          {subDone ? (
            <div style={{ position: 'relative', padding: '14px 24px', background: 'rgba(48,209,88,.1)', border: '1px solid rgba(48,209,88,.25)', borderRadius: 'var(--rsm)', fontSize: 15, color: '#30D158', fontWeight: 700 }}>
              âœ¦ You&apos;re subscribed! See you Sunday.
            </div>
          ) : (
            <form className="nl-form" onSubmit={subscribe}>
              ...
              <button type="submit" className="btn-gold" style={{ whiteSpace: 'nowrap', padding: '13px 24px' }}>Subscribe â†’</button>
            </form>
          )}
