...
const SECTIONS = [
  ...
  },
  {
    ...
    icon: 'â—',
    body: "Nova Pro is billed monthly via Stripe. You can cancel anytime â€” your Pro access continues until the end of the billing period. We don't offer refunds for partial months, but we're flexible if something goes wrong.",
  },
  {
    title: 'Disclaimer',
    icon: 'âœ¦',
...
export default function TermsPage() {
  return (
    <Layout>
      <SEO title="Terms of Service â€” NovaHub" />
      <StaticPage
        badge="Legal"
