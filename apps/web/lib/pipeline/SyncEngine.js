...
export class SyncEngine {
  ...
  async syncProvider(provider, options = {}) {
    ...
    try {
      ...
      console.log(
        `${this.tag} ✓ ${provider.name} complete in ${elapsed}s — synced: ${stats.synced}, failed: ${stats.failed}`,
      );
      ...
      const elapsed = ((Date.now() - startTime) / 1000).toFixed(1);
      console.error(
        `${this.tag} ✗ ${provider.name} failed after ${elapsed}s:`,
        err.message,
      );
      return {
        provider: provider.name,
  ...
  async syncAll() {
    ...
    console.log(`${this.tag} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(
      `${this.tag} Pipeline complete — synced: ${totalSynced}, failed: ${totalFailed}`,
    );
    console.log(`${this.tag} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
