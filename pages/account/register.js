    ...
    <>
      ...
      <div className="page-wrap">
        ...
        <div className="auth-card">
          ...
          <div className="perks">
            <div className="perk"><span className="perk-icon">♥</span><strong>Unlimited Saves</strong>Save as many items as you want</div>
            <div className="perk"><span className="perk-icon">✦</span><strong>AI Recs</strong>Personalised to your taste</div>
            <div className="perk"><span className="perk-icon">📋</span><strong>Lists</strong>Create and share lists</div>
            <div className="perk"><span className="perk-icon">🔄</span><strong>Sync</strong>Any device, anytime</div>
          </div>
