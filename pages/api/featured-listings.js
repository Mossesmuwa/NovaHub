...
// ─── Listing plans ────────────────────────────────────────────────────────────
const PLANS = {
  starter: { name: 'Starter',  price_usd: 99,  features: ['Nova Pick badge', 'Category placement']                                },
  growth:  { name: 'Growth',   price_usd: 249, features: ['Nova Pick badge', 'Category placement', 'Weekly digest mention']        },
  pro:     { name: 'Pro',      price_usd: 499, features: ['Nova Pick badge', 'Category placement', 'Weekly digest', 'Homepage slot'] },
};
